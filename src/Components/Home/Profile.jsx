  ...
  return (
    ...
    <div className={`w-full h-full flex flex-col pb-6  items-center border-t-[1px] border-bodycolor overflow-hidden  justify-center md:pt-5 p-2  bg-white mm:rounded-xl`}>
        <div className='flex justify-center w-full gap-2 mt-4 lg:mt-0 lg:pt-2'>
          <div className='w-[2rem] h-[2rem] mm:w-[1.5rem] mm:h-[1.5rem] flex justify-center items-center rounded-full border-[1px] border-bodycolor mb-4 lg:mb-0'>
        ...
        <div className='relative flex justify-center h-[3.5rem] mm:h-[3rem] w-full border-t-[1px] border-bodycolor mt-12'>
